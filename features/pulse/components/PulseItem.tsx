...
import { ExternalLink, Clock, Zap, Sparkles } from 'lucide-react';
    ...
    <div className="group flex items-start gap-3 px-4 py-3 hover:bg-white/[0.02] border-b border-white/5 last:border-b-0 transition-colors">
      <div className="flex-1 min-w-0 space-y-1.5">
        <div className="flex items-center gap-2 flex-wrap">
          ...
          >
            {item.ai_title || item.lead_name}
          </button>
          {item.ai_title && (
            <span className="text-[10px] font-bold text-muted/70 truncate">
              · {item.lead_name}
            </span>
          )}
          ...
          {isAi && (
            <span
              ...
              title="AI-generated by Pulse (Haiku 4.5)"
            >
              <Sparkles size={9} />
              AI
            </span>
